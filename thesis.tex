...
A Modernização Dirigida a Arquitetura (do inglês - \textit{Architecture-Driven Modernization} (ADM)) é uma nova iniciativa proposta pelo grupo \textit{Object Management Group} (OMG) que define metamodelos padronizados para serem utilizados durante o processo de reengenharia de software. O metamodelo mais importante da ADM é o metamodelo \textit{Knowledge Discovery Metamodel} (KDM) que é ISO e tem como objetivo representar todos os artefatos de um determinado sistema de forma independente de linguagem e plataforma. Um passo primordial durante o processo de reengenharia de software é a aplicação de refatorações. No entanto, até o presente momento existe uma carência de abordagens e apoios ferramentais que auxiliam o processo de refatoração para a ADM e principalmente para o metamodelo KDM.  Dessa forma, nesta Tese é apresentada uma abordagem para criação e disponibilização de refatorações para o metamodelo KDM, bem como um apoio ferramental que permite aplicá-las em diagramas de classe Unified Modeling Language (UML). A abordagem possui dois passos: (i) o primeiro consiste em diretrizes que guiam o engenheiro de modernização durante a criação de refatorações para o KDM; e (ii) o segundo consiste em instanciar um metamodelo que contêm metaclasses que representam metadados relacionados com as refatorações criadas para o KDM e em seguida essa instancia é disponibilizada em um repositório central. O apoio ferramental foi desenvolvido no ambiente de desenvolvido Eclipse e é denominado KDM-RE. Esse apoio ferramental é composto por três plug-ins: (i) o primeiro consiste em um conjunto de Wizard que apoia o engenheiro de software na aplicação das refatorações em diagramas de classe UML; (ii) o segundo consiste em um módulo de propagação de mudanças que permite manter modelos internos do KDM sincronizados e; (iii) o terceiro consiste em um apoio a importação e reuso de refatorações disponíveis no repositório central. Foram realizados dois experimentos que buscaram reproduzir os cenários em que engenheiros de software tivessem que realizar refatorações em uma instância do metamodelo KDM. Os resultados mostram que a abordagem pode trazer benefícios para o engenheiro de software durante a atividade de aplicação de refatorações em sistemas representadas pelo metamodelo KDM.
