...
\begin{longtable}{ | m{1.9cm} | m{3.57cm}| m{9.3cm} | }
 ...
 \hline
 \multicolumn{3}{|c|}{Continuação da Tabela\ref{long}}\\
 \hline
 Refatoração & \multicolumn{2}{|c|}{Propagação}\\
 \hline
 \endhead
