...
\begin{itemize}
	\item \textbf{Meta-associações}
		\begin{itemize}
			...
			\item \texttt{source:Source[0..*]}: define as metaclasses fontes do KDM que serão utilizadas durante a refatoração.
			\item \texttt{target:Target[0..*]}: define as metaclasses alvos do KDM que serão utilizadas durante a refatoração.
