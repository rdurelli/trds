...
\item \texttt{Element} define um conjunto de elementos necessários para executar a refatoração. Essa metaclasse utiliza uma estrutura similar a da tabela \textit{hash} para definir os elementos.
