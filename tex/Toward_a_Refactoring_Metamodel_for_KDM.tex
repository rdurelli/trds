...
A junção dos pacotes apresentados nas seções anteriores e suas metaclasses formam o metamodelo SRM. Na Figura~\ref{fig:meta_modelo_SRM} é apresentado esquematicamente o metamodelo SRM. O SRM contém 13 metaclasses e quatro enumerações. O metamodelo SRM foi implementado utilizando EMF\footnote{\texttt{EString} em EMF representa uma \texttt{String} em Java.}.
