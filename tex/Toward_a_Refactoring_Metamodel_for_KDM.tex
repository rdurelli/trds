...
\begin{itemize}
	\item \textbf{Meta-atributos}
		\begin{itemize}
			...
			\item \texttt{value:KDMEntity}: representa o tipo do elemento. Esse tipo deve ser metaclasses do metamodelo KDM.
		\end{itemize}	
\end{itemize}
