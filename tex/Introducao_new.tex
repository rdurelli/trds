...
\item A escassez de abordagens para criar refatorações para o KDM. Isto é, quais são as diretrizes que permitem o engenheiro de modernização criar refatorações tradicionais para o metamodelo KDM. A ausência de abordagens desse tipo dificulta a condução adequada e efetiva de refatorações para o KDM;
...
\begin{itemize}
	...
	\item Criar um repositório totalmente integrado com a ferramenta para facilitar o compartilhamento e o reuso de refatorações que estão em conformidade com o metamodelo de refatoração proposto; e
