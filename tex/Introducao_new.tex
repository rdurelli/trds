...
De acordo com~\citeonline{Lientz_1978}, a manutenção de software é a atividade mais custosa no ciclo de vida do sistema de software. 
...
Esta tese está organizada em oito~\unsure{verificar a quantidade} capítulos. No primeiro capítulo, estão apresentados a contextualização, a motivação, a abordagem desenvolvida em resumo, os objetivos, as convenções adotadas e o grupo de pesquisa do trabalho. 
