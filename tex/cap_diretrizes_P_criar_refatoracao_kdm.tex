...
Durelli R. S. Capítulo~\ref{chapter:catalogo_refactoring_KDM}     &     \multicolumn{1}{c|}{\checkmark}       & \multicolumn{1}{c|}{\checkmark}    & \multicolumn{1}{c|}{\checkmark}          &    \multicolumn{1}{c|}{\checkmark}                &     \multicolumn{1}{c|}{\checkmark}                       & \multicolumn{1}{c|}{\checkmark}           \\ \hline
~\citeonline{sen2012reusable}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{\checkmark}\\ \hline
~\citeonline{tichelaar2000meta, ducasse2005moose}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}\\ \hline

~\citeonline{Zhang_2005}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}\\ \hline


~\citeonline{brosch2009operation}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{-}\\ \hline

~\citeonline{sun2009model}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{-}\\ \hline

~\citeonline{langer2010model}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}\\ \hline

~\citeonline{astels2002refactoring}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}\\ \hline

~\citeonline{Reimann_2015}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{-}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{\checkmark}&\multicolumn{1}{c|}{-}\\ \hline
\end{tabular}
\end{table}

Na Tabela~\ref{tab:relatedWorks_consideracoes_abordagem} é apresentada uma comparação entre a abordagem apresenta neste capítulo e os trabalhos relacionados quanto à forma como criam refatorações para modelos. Dessa forma, alguns critérios foram definidos durante a comparação, tais critérios são: (\textit{i}) a abordagem fornece diretrizes/passos; (\textit{ii}) a abordagem emprega o metamodelo KDM; (\textit{iii}) a abordagem disponibiliza \textit{templates}; (\textit{iv}) a abordagem considera operações atômicas; (\textit{v}) considera a composição de refatorações; e (\textit{vi}) a abordagem considera restrições. Os colunas da tabela foram abreviadas para caber nas dimensões da páginas, assim, \aspas{ATR} representa \aspas{Autor(es)}, \aspas{DRZ} representa \aspas{Diretrizes}, \aspas{TPT} representa \aspas{\textit{Templates}}, \aspas{OA} representa \aspas{Operações Atômicas}, \aspas{CR} representa \aspas{Composição de Refatoração} e \aspas{RTÇ} representa \aspas{Restrições}. O símbolo \aspas{\checkmark} representa que a abordagem define o critério e o símbolo \aspas{-} representa que a abordagem não define o critério.
