...
\begin{figure}[h]
	...
	\includegraphics[scale=0.7]{images/Abordagem_Criar_RefatoracaoFinal2}
	\fautor
\end{figure}
...
Neste passo, o engenheiro de modernização deve implementar as refatorações para o KDM tendo como base as metaclasses e as operações anteriormente identificadas. Os artefatos de entrada para a correta condução deste passo são: (\textit{i}) linguagem de transformação e (\textit{ii}) um conjunto de \textit{templates}. Após a condução deste passo, o artefato gerado e a refatoração criada para o KDM. 
