...
\sigla{ASTM}{\textit{Abstract Syntax Tree Metamodel}}               & \multicolumn{1}{c|}{Disponível}         & 1.0    & Janeiro/2011  \\ \hline
...
Todos os pacotes do metamodelo KDM apresentado na Figura~\ref{kdm:domain} são organizados em quatro camadas de abstração. Essas quatro camadas estão apresentadas esquematicamente na Figura~\ref{fig:kdm_layer}. A seguir tais camadas são apresentadas:
