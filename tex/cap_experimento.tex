...
No experimento apresentado na Seção~\ref{sec:experimento_KDM_re}, foram aplicados os testes estatísticos \textbf{Shapiro-Wilk} e \textbf{Paried T-Test}, com o apoio da ferramenta R\footnote{\texttt{https://www.r-project.org/}}. Esses testes são brevemente explicados a seguir.% \change{mudar Colocar os testes estatisticos realmentes utilizados}
